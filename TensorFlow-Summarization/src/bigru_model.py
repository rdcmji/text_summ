    ...
    def __init__(self,
        ...
        with tf.variable_scope("seq2seq", dtype=dtype):
            ...
            with tf.variable_scope("attention"):
                ...
                attn_zero=decoder_cell.zero_state(self.batch_size,tf.float32)
                attn_zero=attn_zero.clone(cell_state=self.init_state)
                #wrapper_state = tf.contrib.seq2seq.AttentionWrapperState(
                #    self.init_state, self.prev_att, time=0, alignments=None, alignment_history=())
